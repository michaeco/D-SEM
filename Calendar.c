 ...
 *               DayOfWeek()
 * COMMENTS:
 * $Id: Calendar.c,v 1.2 2002/09/25 05:29:10 nijssen Exp $     
 */
...
{
  if(SCOTT)fprintf(OutFile, "%02d/%02d/%4d %02d:%02d ", Day->Month, Day->Day,
	  Day->Year, Day->Hour, Day->Min);
  else fprintf(OutFile, "%02d/%02d/%4d-%02d:%02d ", Day->Month, Day->Day,
	  Day->Year, Day->Hour, Day->Min);
}
