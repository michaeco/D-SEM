 ...
 *               ReportWarning()
 * COMMENTS:
 * $Id: ReportError.c,v 1.3 2002/09/25 05:01:00 nijssen Exp $     
 */
...
static char *ErrorMessage[] = {
  ...
  "No point source locations specified in file:",	/* 65 */
  "Error in Chemical Species Lookup reference:", /* 66*/
  "Point Source Type not Recognized as WELL or SOURCE:", /* 67 */
  "Number type of variable not recognized", /* 68 */
  "Negative GroundwaterFlux, chems moving against gradient", /*69 */
  "Negative SoilWaterFlux, chems moving against gradient", /*70 */
  "Negative Contribution from a non-point Source is not allowed.", /*71*/
  NULL
};
